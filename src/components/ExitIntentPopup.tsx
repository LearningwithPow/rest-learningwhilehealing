  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md bg-card rounded-2xl shadow-glow p-8 md:p-10 text-center border border-primary/10">
        ...
        >
          REST Reset starts July 28. Small group only. If your mind has been carrying too much, this is your invitation to begin.
        </p>

          <div className="bg-primary/5 rounded-xl px-4 py-3 mb-6">
            <div className="flex items-center justify-center gap-2 mb-1">
              <Timer className="w-4 h-4 text-primary" />
              <span className="text-sm font-medium text-foreground">Early Bird Until July 25</span>
            </div>
